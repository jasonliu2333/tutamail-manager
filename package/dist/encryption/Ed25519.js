...
export { ed25519_generate_keypair as generateEd25519KeyPair, ed25519_sign as signWithEd25519, ed25519_verify as verifyEd25519Signature, } from "./ed25519wasm/crypto_primitives.js";
export async function initEd25519(webAssemblySrc) {
...
export function bytesToEd25519PublicKey(publicKey) {
    return Array.from(publicKey);
}
export function ed25519PublicKeyToBytes(publicKey) {
    return new Uint8Array(publicKey);
}
export function bytesToEd25519PrivateKey(privateKey) {
    return Array.from(privateKey);
}
export function ed25519PrivateKeyToBytes(privateKey) {
    return new Uint8Array(privateKey);
}
export function bytesToEd25519Signature(signature) {
    return Array.from(signature);
}
export function ed25519SignatureToBytes(signature) {
