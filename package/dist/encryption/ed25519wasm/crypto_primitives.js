...
export function ed25519_sign(private_key, message) {
    ...
    const ret = wasm.ed25519_sign(private_key, ptr0, len0);
    return ret;
}
/**
...
export function ed25519_verify(public_key, message, signature) {
    const ptr0 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.ed25519_verify(public_key, ptr0, len0, signature);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('crypto_primitives_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
